...
numCoalTrees=100000 # number of coalescent trees. should be 100000+ if you're doing this for real
numECM=40 # number of ECM optimization cycles. should be 40+ if you're doing this for real
